...
func change_offset(new_value: String, save_settings := true) -> void:
...
func hit_error(new_visible: bool, save_settings := true) -> void:
...
func late_early(new_value: int, save_settings := true) -> void:
...
func toggle_fullscreen(new_visible: bool, save_settings := true) -> void:
...
func _change_key(event: InputEvent, button: String, save_settings := true) -> void:
